...
struct CoverScreenView<GenericRootCoordinator: RootCoordinator>: View {
    // MARK: - Observed
...
struct CoverScreenView_Previews: PreviewProvider {
    static var previews: some View {
        CoverScreenView(model: .init(coordinator: LaunchScreenCoordinator()))
    }
}
