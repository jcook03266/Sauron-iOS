...
class CoverScreenViewModel<GenericRootCoordinator: RootCoordinator>: ObservableObject {
    // MARK: - Observed
    @ObservedObject var coordinator: GenericRootCoordinator
    ...
    init(coordinator: GenericRootCoordinator) {
