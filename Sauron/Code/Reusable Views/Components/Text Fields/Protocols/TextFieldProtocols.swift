...
protocol SatelliteTextFieldModelProtocol: GenericTextFieldModelProtocol {
    // MARK: - General Properties
    // Interior
    var fieldBackgroundColor: Color { get set }
    var textFieldTextColor: Color { get set }
    var textColor: Color { get set }
    var borderColor: Color { get set }
    var borderGradient: LinearGradient? { get set }
    var textFont: FontRepository { get set }
    var fontWeight: Font.Weight { get set }
    ...
    /// i.e hide password button for password textfields
    var satelliteButtonActiveIcon: Image { get set }
    var satelliteButtonInActiveIcon: Image { get set }
    var satelliteButtonAction: (() -> Void) { get set }
    var satelliteButtonIconTint: Color { get set }
    var satelliteButtonBackgroundColor: Color { get set }
    var satelliteButtonShadowColor: Color { get set }
    var activeIcon: Image { get }
...
extension SatelliteTextFieldModelProtocol {
    func focus() {
        DispatchQueue.main.async {
            self.focused = true
        }
